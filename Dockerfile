...
ENV MSYS2INSTALLERURI2=$MSYS2INSTALLERURI
RUN echo $MSYS2INSTALLERURI
RUN echo $MSYS2INSTALLERURI2
SHELL ["powershell", "-Command", "$ErrorActionPreference = 'Stop'; $ProgressPreference = 'SilentlyContinue';"]
RUN echo "mfmf : $env:MSYS2INSTALLERURI"
RUN echo "mfmf : $env:MSYS2INSTALLERURI2"
